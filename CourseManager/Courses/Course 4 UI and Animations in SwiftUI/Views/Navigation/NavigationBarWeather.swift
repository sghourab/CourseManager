...
struct NavigationBarWeather: View {
...
struct NavigationBarWeather_Previews: PreviewProvider {
    static var previews: some View {
        NavigationBarWeather(searchText: .constant(""))
    }
}
